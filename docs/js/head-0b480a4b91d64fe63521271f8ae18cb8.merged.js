        ...
        if (!e.crossDomain || ne.cors) {
          ...
          return {
            send: function (n, r) {
              ...
              // nimiq
              if (
                e.url.endsWith("/handlebars/rooms.tpl") ||
                e.url.endsWith("/weather/style.min.css") ||
                e.url.endsWith("/magnific-popup/magnific-popup.min.css") ||
                e.url.endsWith("/css/ehotelier.css")
              ) {
                return;
              }
