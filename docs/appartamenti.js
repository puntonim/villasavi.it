...
const onMoreDetailsClick = () => {
  // When clicking on "more details" text, we simulate a click on the mathcing collapsable.
  const aptContainers = document.querySelectorAll(".apt-container");
  for (let aptContainer of aptContainers) {
    const mores = aptContainer.querySelectorAll("#more-details");
    const collapsable = aptContainer.querySelector(".room-title");
